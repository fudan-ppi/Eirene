#ifndef BPT_GPUSTM_KERNEL_DEF_H_35
#define BPT_GPUSTM_KERNEL_DEF_H_35
...
#define index_search_with_cache(target_key,last_target_key, ret, local_root, cacheNodeId, isLastThread)\
    INDEX_SEARCH_WITH_CACHE(\
            target_key,\
            last_target_key,\
            ret,\
            local_root,\
