#ifndef BPT_GPUSTM_KERNEL_TX_CUH_35
#define BPT_GPUSTM_KERNEL_TX_CUH_35
...
//NEW COMMIT
    ...
    __forceinline__ __device__ bool TX_COMMIT(
            ...
            volatile keyArr_t *key_section,
            volatile valArr_t *val_section, 
            volatile next_nodeid_t * next_section,
            ...
            volatile offset_t *g_first_leaf,
            version_t root_ver,
...
/*{{{*/
        ...
        //ACQUIRE LOCKS====================================================================
        static __shared__ bool local_lock_map_s[Block_Dim_Put/WARPSIZE][wrtSetSize];
        ...
        __shared__ offset_t tmp_loc_s[Block_Dim_Put/WARPSIZE];
        ...
        if(wrtset_s.size>1){ //修改next指针

            next_section[wrtset_s.loc[1]].nodeid=next_section[wrtset_s.loc[0]].nodeid;
            next_section[wrtset_s.loc[0]].nodeid=wrtset_s.loc[1];
        }
       // __threadfence();
        if(*g_first_leaf==-1){
            *g_first_leaf=wrtset_s.loc[0];
        }
        //__syncwarp();
        __threadfence();
        //REALSE LOCKS==================================================================
